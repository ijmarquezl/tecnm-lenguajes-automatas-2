# Bitácora de Requerimientos y Auditoría IA — Sesión 38
**Materia:** Lenguajes y Autómatas II (SCD-1016)  
**Tema:** Enlace y Creación de Binarios ELF  
...
*Reto:* Llamada a ensamblador as y enlazador gcc  
...
| **Especificación (E)** | Generación de binario ejecutable nativo |
...
*Pruebas ejecutadas:* Comprobación de código de salida ($?)
