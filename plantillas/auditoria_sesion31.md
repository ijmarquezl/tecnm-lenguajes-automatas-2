# Bitácora de Requerimientos y Auditoría IA — Sesión 31
**Materia:** Lenguajes y Autómatas II (SCD-1016)  
**Tema:** Introducción a Ensamblador x86-64  
...
*Reto:* Mapeo de TAC a instrucciones mov/add/sub  
...
| **Especificación (E)** | Sintaxis estándar de ensamblador GNU |
...
*Pruebas ejecutadas:* Ejecución de operaciones aritméticas en CPU
