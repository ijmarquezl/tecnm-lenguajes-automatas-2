# Bitácora de Requerimientos y Auditoría IA — Sesión 36
**Materia:** Lenguajes y Autómatas II (SCD-1016)  
**Tema:** Traducción de Comparaciones y Saltos  
...
*Reto:* Instrucciones cmp, jmp y saltos condicionales  
...
| **Especificación (E)** | Mapeo de banderas de estado de CPU |
...
*Pruebas ejecutadas:* Estructuras if y ciclos en ensamblador
